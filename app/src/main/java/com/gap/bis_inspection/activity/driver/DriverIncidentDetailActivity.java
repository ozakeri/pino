...
public class DriverIncidentDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver_incident_detail);
            ...
            if (result != null) {
                ...
                try {
                    ...
                    if (!resultJson.isNull("incident")) {
                        ...
                        if (!incidentJsonObject.isNull("description")) {
                            descriptionTV.setText(getResources().getString(R.string.incidentDescription_label) + " " + incidentJsonObject.getString("description"));
                        }else {
    ...
    public void logLargeString(String str) {
        String Tag = "resultJsonDriverIncidentDetail = ";
        if(str.length() > 3000) {
