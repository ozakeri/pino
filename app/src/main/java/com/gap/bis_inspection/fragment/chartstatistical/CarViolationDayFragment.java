 ...
 */
public class CarViolationDayFragment extends Fragment {
    ...
    public CarViolationDayFragment() {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_car_day, container, false);
        databaseManager = new DatabaseManager(getActivity());
        coreService = new CoreService(databaseManager);

        carId = getArguments().getString("carId");
        System.out.println("------fff---carId=" + carId);
        ...
        protected Void doInBackground(Void... voids) {
            ...
            if (isDeviceDateTimeValid()) {
                try {
                    ...
                    try {
                        result = postJsonService.sendData("getViolationCodeStatisticallyReportList", jsonObject, true);
