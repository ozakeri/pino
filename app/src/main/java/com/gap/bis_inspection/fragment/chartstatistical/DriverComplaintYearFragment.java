...
import com.gap.bis_inspection.util.GroupingValueFormatter;
 ...
 */
public class DriverComplaintYearFragment extends Fragment {
    TextView yearTV;
    ...
    public DriverComplaintYearFragment() {
                        ...
                        if (!resultJson.isNull(Constants.RESULT_KEY)) {
                            ...
                            if (!jsonObject.isNull("timeSeriesList")) {
                                ...
                                for (int i = 0; i < timeSeriesListArray.length(); i++) {
                                    ...
                                    BarEntry entry = new BarEntry(count, i);
                                    entries.add(entry);
                                }
