 ...
 */
public class DriverIncidentYearFragment extends Fragment {
    TextView yearTV;
    ...
    public DriverIncidentYearFragment() {
    ...
    private ArrayList<String> x_Values() {
        ...
        try {
            xAxis.add(getResources().getString(R.string.label_Statistically_month1));
            xAxis.add(getResources().getString(R.string.label_Statistically_month2));
            xAxis.add(getResources().getString(R.string.label_Statistically_month3));
            xAxis.add(getResources().getString(R.string.label_Statistically_month4));
            xAxis.add(getResources().getString(R.string.label_Statistically_month5));
            xAxis.add(getResources().getString(R.string.label_Statistically_month6));
            xAxis.add(getResources().getString(R.string.label_Statistically_month7));
            xAxis.add(getResources().getString(R.string.label_Statistically_month8));
            xAxis.add(getResources().getString(R.string.label_Statistically_month9));
            xAxis.add(getResources().getString(R.string.label_Statistically_month10));
            xAxis.add(getResources().getString(R.string.label_Statistically_month11));
            xAxis.add(getResources().getString(R.string.label_Statistically_month12));
        } catch (Exception e) {
            e.getMessage();
        }
