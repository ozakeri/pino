 ...
 */
public class CarIncidentMonthFragment extends Fragment {
    ...
    public CarIncidentMonthFragment() {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        //reportDate = HejriUtil.encodeHejriDate(HejriUtil.getYear(reportDate), HejriUtil.getMonth(reportDate), 1);
